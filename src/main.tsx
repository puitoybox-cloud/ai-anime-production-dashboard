...
function App() {
  const [project, setProject] = React.useState<ProjectData>(loadInitialData);
  const [selectedSceneId, setSelectedSceneId] = React.useState<number>(project.scenes[0]?.id ?? 1);
